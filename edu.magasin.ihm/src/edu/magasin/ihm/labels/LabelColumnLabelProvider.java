...
/**
 * Class used to define and customize the Name column rendering
 * 
 * @author RL
 */
public class LabelColumnLabelProvider extends ColumnLabelProvider {

	// Client of the IHM Part
	 ...
	 */
	public LabelColumnLabelProvider(ClientMagasin currentUser) {
